...
func TestPDUSessModCmdRejUnmarshalBinary(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
	...
	}{
		{
			name: "Case 1",
			input: []byte{
				0x2e, 0x05, 0x01, 0xcd, // EPD, PDUSessId, PTI, MsgType
				// ie.Cause5GSM V
				0x00,
...
func TestPDUSessModCmdRejMarshalBinary(t *testing.T) {
	t.Parallel()
